 ...
 *     &lt;/fieldType&gt;
 */
public class StartsWithFilterFactory extends TokenFilterFactory {
  public StartsWithFilterFactory(Map<String, String> aMap) {
      super(aMap);
  }

  @Override
    public StartsWithFilter create(TokenStream aTokenStream) {
      return new StartsWithFilter(aTokenStream);
  }
